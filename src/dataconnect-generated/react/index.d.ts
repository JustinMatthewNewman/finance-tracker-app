...
export function useUpsertPlaidItem(options?: useDataConnectMutationOptions<UpsertPlaidItemData, FirebaseError, UpsertPlaidItemVariables>): UseDataConnectMutationResult<UpsertPlaidItemData, UpsertPlaidItemVariables>;
export function useUpsertPlaidItem(dc: DataConnect, options?: useDataConnectMutationOptions<UpsertPlaidItemData, FirebaseError, UpsertPlaidItemVariables>): UseDataConnectMutationResult<UpsertPlaidItemData, UpsertPlaidItemVariables>;

export function useUpsertBankAccount(options?: useDataConnectMutationOptions<UpsertBankAccountData, FirebaseError, UpsertBankAccountVariables>): UseDataConnectMutationResult<UpsertBankAccountData, UpsertBankAccountVariables>;
export function useUpsertBankAccount(dc: DataConnect, options?: useDataConnectMutationOptions<UpsertBankAccountData, FirebaseError, UpsertBankAccountVariables>): UseDataConnectMutationResult<UpsertBankAccountData, UpsertBankAccountVariables>;

export function useSyncPlaidTransaction(options?: useDataConnectMutationOptions<SyncPlaidTransactionData, FirebaseError, SyncPlaidTransactionVariables>): UseDataConnectMutationResult<SyncPlaidTransactionData, SyncPlaidTransactionVariables>;
export function useSyncPlaidTransaction(dc: DataConnect, options?: useDataConnectMutationOptions<SyncPlaidTransactionData, FirebaseError, SyncPlaidTransactionVariables>): UseDataConnectMutationResult<SyncPlaidTransactionData, SyncPlaidTransactionVariables>;
