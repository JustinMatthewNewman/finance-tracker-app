import { CreateUserFromGoogleData, CreateUserFromGoogleVariables, SetUserTypeData, SetUserTypeVariables, SelectMyColorSchemeData, SelectMyColorSchemeVariables, ClearMyColorSchemeData, SelectMyPerformanceModeData, SelectMyPerformanceModeVariables, SelectMyBackgroundOpacityData, SelectMyBackgroundOpacityVariables, SelectMyExternalAccountLinkTemplateData, SelectMyExternalAccountLinkTemplateVariables, SelectMyCardStyleData, SelectMyCardStyleVariables, SelectMySquareCornersData, SelectMySquareCornersVariables, SelectMyBordersEnabledData, SelectMyBordersEnabledVariables, SelectMyCategoryColorsEnabledData, SelectMyCategoryColorsEnabledVariables, SelectMyCurrencyData, SelectMyCurrencyVariables, CreateFamilyMemberData, CreateFamilyMemberVariables, UpdateFamilyMemberData, UpdateFamilyMemberVariables, RenameFamilyMemberData, RenameFamilyMemberVariables, DeleteFamilyMemberData, DeleteFamilyMemberVariables, UpsertCategoryData, UpsertCategoryVariables, UpdateCategoryData, UpdateCategoryVariables, CreateTransactionData, CreateTransactionVariables, UpdateTransactionData, UpdateTransactionVariables, UpdateTransactionClearCategoryData, UpdateTransactionClearCategoryVariables, MarkTransactionPostedData, MarkTransactionPostedVariables, MarkTransactionProjectedData, MarkTransactionProjectedVariables, DeleteTransactionData, DeleteTransactionVariables, CreateFamilyData, CreateFamilyVariables, RequestToJoinFamilyData, RequestToJoinFamilyVariables, ApproveJoinRequestData, ApproveJoinRequestVariables, DenyJoinRequestData, DenyJoinRequestVariables, CancelMyJoinRequestData, CancelMyJoinRequestVariables, LeaveMyFamilyData, LeaveMyFamilyVariables, RegenerateFamilyInviteCodeData, RegenerateFamilyInviteCodeVariables, CreateUserSettingForUserData, CreateUserSettingForUserVariables, CreateSelfFamilyMemberForUserData, CreateSelfFamilyMemberForUserVariables, ListUsersData, GetMyUserData, ListColorSchemesData, ListUserTypesData, GetUserAccessByGoogleUidData, GetUserAccessByGoogleUidVariables, GetUserProvisioningByGoogleUidData, GetUserProvisioningByGoogleUidVariables, ListFamilyMembersData, ListFamilyMembersVariables, ListCategoriesData, ListCategoriesVariables, ListTransactionsByFamilyMemberData, ListTransactionsByFamilyMemberVariables, ListMyTransactionsData, ListMyTransactionsVariables, ListMyTransactionsByDateRangeData, ListMyTransactionsByDateRangeVariables, GetFamilyByInviteCodeData, GetFamilyByInviteCodeVariables, GetMyFamilyDetailData, GetMyJoinRequestsData, ListMyRecurringProjectionsData, ListMyRecurringProjectionsVariables } from '../';
...
export function useCreateSelfFamilyMemberForUser(options?: useDataConnectMutationOptions<CreateSelfFamilyMemberForUserData, FirebaseError, CreateSelfFamilyMemberForUserVariables>): UseDataConnectMutationResult<CreateSelfFamilyMemberForUserData, CreateSelfFamilyMemberForUserVariables>;
export function useCreateSelfFamilyMemberForUser(dc: DataConnect, options?: useDataConnectMutationOptions<CreateSelfFamilyMemberForUserData, FirebaseError, CreateSelfFamilyMemberForUserVariables>): UseDataConnectMutationResult<CreateSelfFamilyMemberForUserData, CreateSelfFamilyMemberForUserVariables>;
...
export function useListMyRecurringProjections(vars: ListMyRecurringProjectionsVariables, options?: useDataConnectQueryOptions<ListMyRecurringProjectionsData>): UseDataConnectQueryResult<ListMyRecurringProjectionsData, ListMyRecurringProjectionsVariables>;
export function useListMyRecurringProjections(dc: DataConnect, vars: ListMyRecurringProjectionsVariables, options?: useDataConnectQueryOptions<ListMyRecurringProjectionsData>): UseDataConnectQueryResult<ListMyRecurringProjectionsData, ListMyRecurringProjectionsVariables>;
