                    ...
                    <div className="pointer-events-auto mt-10 flex flex-wrap items-center justify-center gap-3">
                        {loading ? (
                            ...
                            >
                                ...
                                />
                                {!user && <GoogleIcon />}
                                {user ? "Go to household" : "Sign in with Google"}
                            </Button>
                        )}
            ...
            <footer className="border-t border-border py-4">
                <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-4 px-6 text-center md:flex-row md:text-left">
                    ...
                    <div className="flex flex-wrap items-center justify-center gap-6 md:justify-start">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <div className="text-left">
                                ...
                                <p className="glisten-text text-[9px] font-semibold uppercase tracking-wider">Top Rated Family Budgeter</p>
                            </div>
                        </div>
                    ...
                    <div className="flex items-center gap-3">
                        <a
                            href="https://github.com/JustinMatthewNewman/finance-tracker-app"
                            target="_blank"
                        ...
                        <span className="text-xs text-foreground/50">
                            © {new Date().getFullYear()} Finance Tracker Pro. All rights reserved.
                        </span>
                    </div>
                </div>
            </footer>
